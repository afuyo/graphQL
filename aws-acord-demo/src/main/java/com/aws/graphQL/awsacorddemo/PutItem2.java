...
public class PutItem2
{
    public static void main(String[] args)
    {
        ...
        String[] myargs = new String[] {"PocAPerson-bwj6lt6ts5harekarfjyza4eim","14","birthDateTime=197003101032","genderCode=A"};
        args=myargs.clone();
       /** args[0]=myargs[0];
        args[1]=myargs[1];
        args[2]=myargs[2];**/
        ...
        System.out.format("Adding \"%s\" to \"%s\"", partyKey, table_name);
       ...
       // item_values.put("id",new AttributeValue(randomUUIDString));
        item_values.put("id", new AttributeValue(ff_nr));
        item_values.put("partyKey", new AttributeValue(partyKey));
